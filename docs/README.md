...
- Next iteration: [001 - Project foundation](iterations/001-project-foundation.md)
...
| --- | --- | --- |
| [001](iterations/001-project-foundation.md) | Establish the Rust project and safe terminal lifecycle | Planned |
